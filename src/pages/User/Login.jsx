...
import { login, stage } from '../../redux/userReducer'; // logout, register, user
        ...
        <div className="d-flex flex-column justify-content-center align-items-center mt-1 px-5 py-2 bg-light rounded shadow-lg" style={{width: '40%'}}>
          ...
          <div className="w-100">
              <div className="d-flex flex-column w-100">
                  ...
                  <Link to={'#'} style={{textDecoration: 'none',fontWeight: '500'}} className="p-0 m-0 ps-1" aria-disabled>Forgot password?</Link>
              </div>
